...
insert into uscho_women.rounds
...
from uscho_women.rounds r1
left join uscho_women.rounds r2
...
join uscho_women._schedule_factors sf1
  on (sf1.year,sf1.school_id)=(r1.year,r1.school_id)
left join uscho_women._schedule_factors sf2
