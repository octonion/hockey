...
drop table if exists uscho_women._schedule_factors;

create table uscho_women._schedule_factors (
        school_id		text,
	year			integer,
        offensive               float,
        defensive		float,
...
strength=o.strength
from uscho_women._schedule_factors o
