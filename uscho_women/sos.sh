...
psql hockey -c "drop table if exists uscho_women.results;"

psql hockey -f sos/standardized_results.sql

psql hockey -c "vacuum full verbose analyze uscho_women.results;"

psql hockey -c "drop table uscho_women._basic_factors;"
psql hockey -c "drop table uscho_women._parameter_levels;"

R --vanilla -f sos/lmer.R

psql hockey -c "vacuum full verbose analyze uscho_women._parameter_levels;"
psql hockey -c "vacuum full verbose analyze uscho_women._basic_factors;"

psql hockey -f sos/normalize_factors.sql
psql hockey -c "vacuum full verbose analyze uscho_women._factors;"

psql hockey -f sos/schedule_factors.sql
psql hockey -c "vacuum full verbose analyze uscho_women._schedule_factors;"
