...
drop table if exists href._schedule_factors;

create table href._schedule_factors (
	team_id			text,
	year			integer,
        offensive               float,
        defensive		float,
